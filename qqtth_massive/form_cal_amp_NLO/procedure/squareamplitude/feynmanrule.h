...
id vrtx(Uug,i1?,p1?,i2?,p2?,i3?,p3?)=i_*gs*g(i2,i1,i3)*t(i3,i2,i1);
id vrtx(Ttg,i1?,p1?,i2?,p2?,i3?,p3?)=i_*gs*g(i2,i1,i3)*t(i3,i2,i1);
id vrtx(Tth,i1?,p1?,i2?,p2?,i3?,p3?)=i_*Y*g(i2,i1)*ch(i2,i1);
...
id fprop(i1?,i2?,p?,m?)=i_*(g(i1,i2,p)+g(i1,i2)*m)*fprop(i2,i1)*prop(p.p-m^2);
