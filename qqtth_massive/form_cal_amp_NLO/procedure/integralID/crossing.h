...
*if (match(Sector(pentagon1x34,?a)));
*   Multiply replace_(p3,p4,p4,p3);
...
*endif;
*
*if (match(Sector(pentagon2x12x34,?a)));
*   Multiply replace_(p1,p2,p2,p1,p3,p4,p4,p3);
*   id Sector(pentagon2x12x34,?a)=Sector(pentagon2,?a)*cross2x12x34;
*endif;
*
*if (match(Sector(pentagon2x34,?a)));
*   Multiply replace_(p3,p4,p4,p3);
*   id Sector(pentagon2x12x354,?a)=Sector(pentagon2,?a)*cross2x12x354;
*endif;
