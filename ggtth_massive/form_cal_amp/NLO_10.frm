...
#include ./procedure/squareamplitude/scalarproduct.h
...
CFunction UB,U,VB,V,Epsilon,EpsilonB;
CFunction ghprop,glprop,fprop,vrtx,prop;
CFunction f(antisymmetric),g,t,gl,gh,gv,gg,ch,mom;
...
Multiply left Epsilon(-1,p1,0)*Epsilon(-3,p2,0)*UB(-2,p3,mt)*V(-4,p4,mt);
.sort
